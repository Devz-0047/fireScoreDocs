...
const config = {
  ...
  projectName: 'firescore', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Team Phoenix. Built with Docusaurus.`,
      },
      prism: {
